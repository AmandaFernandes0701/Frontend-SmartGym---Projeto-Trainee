...
const frames = [
    {
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/cerrote.jpg" className="cerrote" alt=""/>,
    },
    {
        id: 2,
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/triceps.jpg" className="triceps" alt=""/>,
    },
    {
        id: 3,
        title: "Flexão",
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/flexao.jpg" className="flexao" alt=""/>,
    },
    {
        id: 4,
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/agachamento.jpg" className="agachamento" alt=""/>,
    },
    {
        id: 5,
        title: "Leg Press",
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/legpress.jpg" className="legpress" alt=""/>,
    },
    {
        id: 6,
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/extensora.jpg" className="extensora" alt=""/>,
    },
    {
        id: 7,
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/perna.jpg" className="perna" alt=""/>,
    },
    {
        id: 8,
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/ombro.jpg" className="ombro" alt=""/>,
    },
    {
        id: 9,
        title: "Downward Dog",
        ...
        image: <img style={{ width: "100%", height: "100%" }} src="images/downward.jpg" className="downward" alt=""/>,
    },
];
